...
window.stationPageExtras = {
  ...
  lepseny: {
    ...
    map: {
      image: "assets/img/lepsenybelso.png",
      source: "assets/maps/terkep_lepseny_v2427.pdf",
      hu: {
        title: "\u00c1llom\u00e1st\u00e9rk\u00e9p",
        ...
        cards: [
          {
            icon: "bi-geo-alt-fill",
            title: "C\u00edm",
            body: "7081 Simontornya, Vas\u00fat\u00e1llom\u00e1s"
          },
          {
            icon: "bi-cash-coin",
            title: "P\u00e9nzt\u00e1r",
        ...
        cards: [
          {
            icon: "bi-geo-alt-fill",
            title: "Address",
            body: "7081 Simontornya, railway station"
          },
          {
            icon: "bi-cash-coin",
            title: "Ticket Office",
  ...
  balatonaliga: {
    ...
    map: {
      image: "assets/img/balatonaligabelso.jpg",
      source: "assets/maps/terkep_balatonaliga_v2428.pdf",
      hu: {
        title: "Állomástérkép",
  ...
  balatonalmadi: {
    map: {
      image: "assets/img/balatonalmadibelso.jpg",
      source: "assets/maps/terkep_balatonalmadi_v2424.pdf",
      hu: {
        title: "Állomástérkép",
  ...
  balatonboglar: {
    ...
    map: {
      image: "assets/img/balatonboglarbelso.jpg",
      source: "assets/maps/terkep_balatonboglar_v2421.pdf",
      hu: {
        title: "Állomástérkép",
  ...
  gyekenyes: {
    ...
    map: {
      image: "assets/img/gyekenyesbelso.jpg",
      source: "assets/maps/terkep_gyekenyes_v2419.pdf",
  ...
  balatonszarszo: {
    ...
    map: {
      image: "assets/img/balatonszarszobelso.jpg",
      source: "assets/maps/terkep_balatonszarszo_v2423.pdf",
  ...
  balatonszemes: {
    ...
    map: {
      image: "assets/img/balatonszemesbelso.jpg",
      source: "assets/maps/terkep_balatonszemes_v2442.pdf",
      hu: {
        title: "Állomástérkép",
  ...
  balatonszentgyorgy: {
    ...
    map: {
      image: "assets/img/balatonszentgyorgybelso.jpg",
      source: "assets/maps/terkep_balatonszentgyorgy_v2422.pdf",
      hu: {
        title: "Állomástérkép",
  ...
  sarbogard: {
    ...
    map: {
      image: "assets/img/sarbogardbelso.jpg",
      source: "assets/maps/terkep_sarbogard_v2440.pdf",
      hu: {
        title: "Állomástérkép",
  ...
  zamardi: {
    ...
    map: {
      image: "assets/img/zamardibelso.jpg",
      source: "assets/maps/terkep_zamardi_v2421.pdf",
      hu: {
        title: "Állomástérkép",
  ...
  szantod: {
    ...
    map: {
      image: "assets/img/szantodbelso.jpg",
      source: "assets/maps/terkep_szantod_v2431.pdf",
      hu: {
        title: "Állomástérkép",
  ...
  siofok: {
    ...
    map: {
      image: "assets/img/siofokbelso.jpg",
  ...
  villany: {
    ...
    map: {
      image: "assets/img/villanybelso.jpg",
      source: "assets/maps/terkep_villany_v2446.pdf",
      hu: {
        title: "Állomástérkép",
  ...
  balatonfoldvar: {
    ...
    map: {
      image: "assets/img/balatonfoldvarbelso.jpg",
      source: "assets/maps/terkep_balatonfoldvar_v2427.pdf",
      hu: {
        title: "Állomástérkép",
  ...
  balatonbereny: {
    ...
    map: {
      image: "assets/img/balatonberenybelso.jpg",
      source: "assets/maps/terkep_balatonbereny_v2438.pdf",
      hu: {
        title: "Állomástérkép",
  ...
  szekszard: {
    ...
    map: {
      image: "assets/img/szekszardbelso.jpg",
