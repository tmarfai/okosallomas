      ...
      return `
        <div class="mt-3 pt-2 border-top" style="display: block !important;">
          ...
          <a href="${link.url}" target="_blank" style="display: inline-block;">
            <img src="${okosallomasAssetUrl(link.image)}" alt="${link.alt || label}" style="width: 140px; height: auto; cursor: pointer; border-radius: 8px; box-shadow: 0 2px 6px rgba(0,0,0,0.15);">
          </a>
        </div>`;
    }
